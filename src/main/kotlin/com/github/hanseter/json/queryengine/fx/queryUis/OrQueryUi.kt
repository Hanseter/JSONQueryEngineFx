...
import com.github.hanseter.json.queryengine.OrQuery.OrQueryBuilder
import com.github.hanseter.json.queryengine.OrQuery
...
class OrQueryUi(dndManager: DragAndDropManager) : TitledPane(), QueryBuilderUi<OrQuery> {
	private val queryBuilder = OrQueryBuilder()
	...
	override fun getQueryBuilder(): QueryBuilder<OrQuery> = queryBuilder
